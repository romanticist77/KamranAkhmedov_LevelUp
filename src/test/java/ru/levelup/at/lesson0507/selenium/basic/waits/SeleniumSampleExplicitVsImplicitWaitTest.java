package ru.levelup.at.lesson0507.selenium.basic.waits;
...
public class SeleniumSampleExplicitVsImplicitWaitTest {
    ...
    @Test
    public void searchExplicitMoreThenImplicitWaitTest() {
    ...
    @Test
    public void searchExplicitLessThenImplicitWaitTest() {
    ...
    @Test
    public void searchExplicitWithImplicitWaitTest() {
        driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(8));
        wait = new WebDriverWait(driver, Duration.ofSeconds(6));
    ...
    public void searchFailTest() {
        ...
        try {
            ...
            var searchResults =
                wait.until(ExpectedConditions.numberOfElementsToBeMoreThan(By.xpath("//div/a/h3"), 12));
            assertThat(searchResults).as("Не найдено результатов").hasSizeGreaterThan(12);
        } finally {
            var endTime = System.currentTimeMillis();
            System.out.println("Время выполнения: " + (endTime - startTime) + "ms");
