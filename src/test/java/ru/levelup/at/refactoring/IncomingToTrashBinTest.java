...
public class IncomingToTrashBinTest {
    ...
    public void successfulRoutingTest() {
        ...
        var removeButton = wait.until(ExpectedConditions.visibilityOfElementLocated(
            By.xpath("//div[text()='Удалить']/parent::span")));
        removeButton.click();

        var trashBin = wait.until(ExpectedConditions.visibilityOfElementLocated(
            By.xpath("//div[text()='Корзина']")));
        trashBin.click();
